  ...
  datasets: [
    {
      labels: ["circle"],
      data: [20, 10,22,20,20],
      backgroundColor: ["rgba(180,206,255,1)", "rgba(255,255,255,1)","rgba(255,255,255,1)","rgba(255,255,255,1)","rgba(255,255,255,1)"],
...
const barData = {
  ...
  datasets: [
    {
      label: 'Progress',
      data: [100,150,200,250,300,350,215,301,110,119,220,256,99,36,55],
      ...
      <div className="chart-section">
        ...
        <div className="chart-right">
          <div className="days-header">
            <p className="days-header-left">Last 14 Days Active Workers In Training</p>
